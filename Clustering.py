...
def read_normalised_frequencies(polymers, *genomes):
    ...
    """
    genome_names = [g['name'] for g in genomes]  # capture genome names
    ...
    principal_component_analysis(nf_df, polymers, genome_names, polymer_name)
    tSNE(nf_df, polymers, genome_names, polymer_name)


def seaborn_scatterplot(model, results, polymers, genome_names, polymer_name):
...
def principal_component_analysis(df, polymers, genome_names, polymer_name):
    ...
    seaborn_scatterplot("PCA", pca_results, polymers, genome_names, polymer_name)


def tSNE(pca_results, polymers, genome_names, polymer_name):
    ...
    seaborn_scatterplot("t-SNE", tsne_results, polymers, genome_names, polymer_name)
